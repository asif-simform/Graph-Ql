...
export type FetchShipsQuery = (
  { __typename?: 'Query' }
  & { ships?: Maybe<Array<Maybe<(
    { __typename?: 'Ship' }
    & Pick<Ship, 'id' | 'image' | 'model' | 'name'>
  )>>> }
);

export type FetchShipQueryVariables = Exact<{
  id?: Maybe<Scalars['ID']>;
}>;


export type FetchShipQuery = (
  { __typename?: 'Query' }
  & { ships?: Maybe<Array<Maybe<(
    { __typename?: 'Ship' }
    & Pick<Ship, 'id' | 'image' | 'model' | 'name'>
...
export const FetchShipsDocument = gql`
    query fetchShips {
  ships(limit: 10) {
    id
    image
...
/**
 * __useFetchShipsQuery__
 *
 * To run a query within a React component, call `useFetchShipsQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchShipsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchShipsQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchShipsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchShipsQuery, FetchShipsQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchShipsQuery, FetchShipsQueryVariables>(FetchShipsDocument, baseOptions);
      }
export function useFetchShipsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchShipsQuery, FetchShipsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchShipsQuery, FetchShipsQueryVariables>(FetchShipsDocument, baseOptions);
        }
export type FetchShipsQueryHookResult = ReturnType<typeof useFetchShipsQuery>;
export type FetchShipsLazyQueryHookResult = ReturnType<typeof useFetchShipsLazyQuery>;
export type FetchShipsQueryResult = ApolloReactCommon.QueryResult<FetchShipsQuery, FetchShipsQueryVariables>;
export const FetchShipDocument = gql`
...
/**
 * __useFetchShipQuery__
 *
 * To run a query within a React component, call `useFetchShipQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchShipQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchShipQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useFetchShipQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchShipQuery, FetchShipQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchShipQuery, FetchShipQueryVariables>(FetchShipDocument, baseOptions);
      }
export function useFetchShipLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchShipQuery, FetchShipQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchShipQuery, FetchShipQueryVariables>(FetchShipDocument, baseOptions);
        }
export type FetchShipQueryHookResult = ReturnType<typeof useFetchShipQuery>;
export type FetchShipLazyQueryHookResult = ReturnType<typeof useFetchShipLazyQuery>;
export type FetchShipQueryResult = ApolloReactCommon.QueryResult<FetchShipQuery, FetchShipQueryVariables>;